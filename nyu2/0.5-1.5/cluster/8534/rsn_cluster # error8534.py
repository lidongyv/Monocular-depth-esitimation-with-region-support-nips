...
# @Last Modified time: 2018-08-10 10:34:45
...
class rsn_cluster(nn.Module):
    ...
    def __init__(self, 
        ...
        self.pyramid_pooling = pyramidPoolingGroupNorm(128, [[120,160],[60,80],[48,64],[30,40],[24,32],[12,16],[6,8],[3,4]],group_dim=group_dim)
        ...
        self.class1= conv2DGroupNormRelu(in_channels=192, k_size=3, n_filters=128,
                                                 padding=1, stride=1, bias=False,group_dim=128)
