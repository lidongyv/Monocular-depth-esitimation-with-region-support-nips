...
# @Last Modified time: 2018-07-31 09:53:14
...
class rsn_mask(nn.Module):
    ...
    def __init__(self, 
        ...
        self.class1= conv2DBatchNormRelu(in_channels=256, k_size=3, n_filters=128,
                                                 padding=1, stride=1, bias=False)
        self.class2= conv2DBatchNormRelu(in_channels=128, k_size=3, n_filters=70,
                                                 padding=1, stride=1, bias=False)
        self.class3= conv2DBatchNormRelu(in_channels=70, k_size=3, n_filters=70,
                                                 padding=1, stride=1, bias=False)
